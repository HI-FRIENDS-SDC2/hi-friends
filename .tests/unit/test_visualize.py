...
def test_visualize():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        data_path = PurePosixPath(".tests/unit/visualize/data")
        expected_path = PurePosixPath(".tests/unit/visualize/expected")
        ...
        # dbg
        print("results/plots/output_params_distribution.png", file=sys.stderr)
